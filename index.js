...
async function createRolesPanel(message) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription(
            "Pick your Pronouns, Pings, or Shifts by clicking the buttons below and selecting roles from the dropdown. Unselect to remove. Contact @Moderation Team if issues."
        )
